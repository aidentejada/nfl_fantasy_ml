...
weekly.to_csv('data_local/raw_weekly.csv', index=False)
snaps.to_csv('data_local/raw_snaps.csv', index=False)
...
rankings.to_csv('data_local/raw_rankings_2025.csv', index=False)
weekly_2025.to_csv('data_local/raw_weekly_2025.csv', index=False)
snaps_2025.to_csv('data_local/raw_snaps_2025.csv', index=False)
