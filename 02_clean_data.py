...
weekly_train = pd.read_csv('data_local/raw_weekly.csv', low_memory=False)
weekly_2025 = pd.read_csv('data_local/raw_weekly_2025.csv')
weekly = pd.concat([weekly_train, weekly_2025], ignore_index=True)

snaps_train = pd.read_csv('data_local/raw_snaps.csv')
snaps_2025 = pd.read_csv('data_local/raw_snaps_2025.csv')
...
skill.to_csv('data_local/clean_weekly.csv', index=False)
print("Cleaned data_local saved!")
print(skill.shape)
